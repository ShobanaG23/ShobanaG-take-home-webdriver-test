...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext){		
		...
		htmlReporter.config().setDocumentTitle("Dotdashcom_AssessmentShobana Automation Report"); // Tile of report
		htmlReporter.config().setReportName("Dotdashcom_AssessmentShobana Functional Testing"); // name of the report
